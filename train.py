"""Solution A (aggressive, uid232) - final recipe v2 (2026-07-18).
...
Key points (all measurement-backed):
  ...
  - merged-batch boost 1.3: prioritize the live shape (A's aggressive edge)
  - recency halflife 3: focus on the most recent days
  - 343 features incl. creative set (combined.py)
...
HALFLIFE = 3.0                 # A: focus on the most recent days
MERGED_BOOST = 1.3             # A: upweight live-shape (100-hand) batches
...
def main(train_on_all=True):
    mirror = _mirror()
    print("Solution A: mirrored + mixed shapes (native+merged100), merged boost 1.3, halflife 3")
